...
export const subjectMessages = defineMessages({
    ...
    active: {
        id: 'subject.status.active',
        defaultMessage: 'Active',
    },
    inactive: {
        id: 'subject.status.inactive',
    ...
    subjectDetails: {
        id: 'subject.details',
        defaultMessage: 'Subject Details',
    },
    saveSubject: {
        id: 'subject.save',
        defaultMessage: 'Save Subject',
    },
});
